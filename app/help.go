...
func (h helpTypeGeneral) toContent() string {
	content := lipgloss.JoinVertical(lipgloss.Left,
		...
		"",
		headerStyle.Render("New Session:"),
		keyStyle.Render("n")+descStyle.Render("         - New pi-mono session"),
		keyStyle.Render("b")+descStyle.Render("         - New opencode session"),
		keyStyle.Render("m")+descStyle.Render("         - New claude session"),
		keyStyle.Render("N")+descStyle.Render("         - New session with prompt (pick program/branch)"),
		"",
		...
		keyStyle.Render("[ / ]")+descStyle.Render("    - Switch between workspace tabs"),
		descStyle.Render("           Green tab = agent needs attention"),
		"",
